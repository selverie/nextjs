...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import type { CSSValue } from "./types";
&nbsp;
/**
...
export const compose =
  ...
  (...styleArgs: Array&lt;CSSValue | Array&lt;CSSValue&gt;&gt;) =&gt; {
    const result = funcs.reduce((acc, func, i) =&gt; {
      ...
      return `${acc} ${Array.isArray(arg) ? <span class="branch-0 cbranch-no" title="branch not covered" >func(...arg) :</span> func(arg)}`;
    }, "");
    return result.trim();
  };
&nbsp;
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Sun Feb 20 2022 16:31:32 GMT+0800 (China Standard Time)
            </div>
        </div>
